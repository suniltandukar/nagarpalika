	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="col-md-12 col-xs-12">
			<div class="x_panel">
					...
					<tbody>
					<c:forEach items="${houseRent}" var="hr">
						<tr>
							<td>${hr.houseOwnerDetailModel.house_owner_id }</td>
							<td>${hr.land_house_id}</td>
							<td><a href="<spring:url value="/houseRent/edit/${hr.house_rent_id }"/>">Edit</a></td>
						</tr>
						</c:forEach>
					</tbody>
					</table>
