...
<body class="background">
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="col-md-8 col-xs-12">
			<div class="x_panel">
				<spring:url value="/relation/save" var="formUrl" />
				<form:form class="form-horizontal form-label-left input_mask"
					method="post" action="${formUrl }">

					<div class="x_title">
						<h2>FAMILY RELATION</h2>
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="col-md-8 col-xs-12">
			<div class="x_panel">
					<div class="x_title">
						<h2>AVAILABLE FAMILY RELATION</h2>
						...
						<table class="table jambo_table table-striped table-bordered dt-responsive nowrap display dataTable dtr-inline" style="font-size: 95%; width: 100%;">
							...
							<c:forEach items="${findAll }" var="f">
								<tr>
									<td>${f.relation_id }</td>
									<td>${f.name }</td>
									<td><a href="<spring:url value="/relation/findById/${f.relation_id }"/>">Edit</a></td>
								</tr>
								</c:forEach>
							</tbody>
						</table>
