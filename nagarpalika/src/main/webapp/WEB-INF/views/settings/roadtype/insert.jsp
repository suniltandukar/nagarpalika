...
<body class="background">
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="col-md-8 col-xs-12">
			<div class="x_panel">
				<spring:url value="/roadtype/save" var="formUrl" />
					...
					<div class="x_content">
						<table class="table jambo_table table-striped table-bordered dt-responsive nowrap display dataTable dtr-inline" style="font-size: 95%; width: 100%;">
							...
							<c:forEach items="${findAll }" var="f">
								<tr>
									<td>${f.road_type_id }</td>
									<td>${f.road_type }</td>
									<td><a href="<spring:url value="/roadtype/findById/${f.road_type_id }"/>">Edit</a></td>
								</tr>
								</c:forEach>
							</tbody>
						</table>
