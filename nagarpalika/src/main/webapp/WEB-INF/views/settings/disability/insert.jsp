...
<body class="background">
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="col-md-8 col-xs-12">
			<div class="x_panel">
				<spring:url value="/disability/save" var="formUrl" />
						...
						<table class="table">
							<tbody>
								...
								<td><h6>
										...
										</h6> <input type='text' class='form-control' name='id' maxlength="2"></td>
									<td><h6>
											<strong>Disability Type</strong>
										</h6> <input type='text' class='form-control' name='typehead'></td>
								</tr>
							</tbody>
						</table>
					</div>
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="col-md-8 col-xs-12">
			<div class="x_panel">
					<div class="x_title">
						<h2>AVAILABLE DISABILITY TYPE</h2>
						...
						<table class="table jambo_table table-striped table-bordered dt-responsive nowrap display dataTable dtr-inline" style="font-size: 95%; width: 100%;">
							...
							<c:forEach items="${findAll }" var="f">
								<tr>
									<td>${f.id }</td>
									<td>${f.typehead }</td>
									<td><a href="<spring:url value="/disability/findById/${f.id }"/>">Edit</a></td>
								</tr>
								</c:forEach>
							</tbody>
						</table>
